...
<body>
<section class="vh-100" style="background-color: #D5D5D5;">
              ...
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form action="proses_login.php" method="POST">
                  ...
                  <div class="d-flex align-items-center mb-3 pb-1">
                    ...
                    <img src="">    
                    <span class="h1 fw-bold mb-0">&nbsp;King Vape</span>
                  </div>

                  <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Masuk akunmu</h5>
